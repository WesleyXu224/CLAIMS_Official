...
def main(args=None):
    ...
    # import pdb;pdb.set_trace()#POINT 1
    ...
    if is_using_data:
        iterator = iter(data)
        input_motion, model_kwargs = next(iterator)#Here to use that function
    ...
    # tensor = model_kwargs['y']['prefix']  # 形状 [6, 263, 1, 20]
    # numpy_array = tensor.detach().cpu().numpy()
    # # 保存为 .npy 文件
    # np.save("prefix_data.npy", numpy_array)
    # import pdb;pdb.set_trace()
    # original_tensor = model_kwargs['y']['prefix']  # 形状 [6, 263, 1, 20]
    # model_kwargs['y']['prefix']  = torch.cat([
    ...
    # out_path = "/home/group16/xuws/MDM_DIP/motion-diffusion-model/visualize/save/humanml_trans_dec_512_bert/models_to_upload/humanml_trans_dec_512_bert/test"
