...
def add_model_options(parser):
    ...
    group.add_argument("--prompts_path", required=True, help='提示文件所在目录（如 prompts/gmxv2）')
    group.add_argument('--prompts_file_names', required=True, nargs='+', help='提示文件名列表（空格分隔，如 gmxv2_difficulty_3_prompts.txt）')
    group.add_argument('--motion_save_path', required=True, help='运动结果保存目录（如 gmxv2_difficulty_3_prompts_motions）')
