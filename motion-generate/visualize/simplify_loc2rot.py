...
class joints2smpl:
    ...
    def __init__(self, num_frames, device_id, cuda=True):
        ...
        self.fix_foot = False
        # config.SMPL_MODEL_DIR = "/home/group16/xuws/PHC/motion-diffusion-model/body_models"
        ...
        # config.SMPL_MEAN_FILE = "/home/group16/xuws/PHC/motion-diffusion-model/visualize/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
